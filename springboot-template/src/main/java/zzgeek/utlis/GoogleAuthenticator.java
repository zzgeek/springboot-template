...
public class GoogleAuthenticator {
    ...
    private static final String SEED = "1g8GjEvTbW5oVSV7avL47357438reyhreyuryetredLDVKs2m0QN7vxRs2im5MDaNCWGmcD2rvcZx2";
    // Java实现随机数算法
    ...
    public static boolean googleAuthenticator(String googleSecret, String code) {
        try {
            long t = System.currentTimeMillis();
            GoogleAuthenticator ga = new GoogleAuthenticator();
            ga.setWindowSize(5);
            return ga.check_code(googleSecret, Long.parseLong(code), t);
        } catch (Exception e) {
            return false;
        }
    }
